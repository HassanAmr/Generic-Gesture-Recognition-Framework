...
{	
	...
	if (argc > 1)
    {
  	...
  	{
  		printf("Too few arguments. Please provide the number of inputs.");
		return 1;
  	}
	...
	while (running)
	{
		...
		//classifier->predict( inputVector );
		//predictedClass = classifier->getPredictedClassLabel();
